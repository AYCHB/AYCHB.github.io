...
$pdf->Cell(280,12,"AYCHBank: https://aychbank.github.io",0,0,TRUE);
$pdf->Ln();
...
$pdf->Cell(280,12,"All Transactions From All Banks",1,0,'C',TRUE);
...
$pdf->Cell(53,15,"From ACC.NO/IBAN",1,0,'C',TRUE);
$pdf->Cell(40,15,"To Customer",1,0,'C',TRUE);
$pdf->Cell(53,15,"To ACC.NO/IBAN",1,0,'C',TRUE);
...
$pdf->Ln();
        ...
        //$email = $_SESSION['login'];
         ...
         $sql2 = "select date_transfer, _from_customer_lastname, _from_customer_firstname, 
                  ...
                  where  _from_customer_accno_iban = '$account_no' or _from_customer_accno_iban = '$IBAN'
        ...
        while($row2=$result2->fetch_assoc())
            ...
            $_from_customer_accno_iban = $row2['_from_customer_accno_iban'];
            ...
            $_to_customer_accno_iban = $row2['_to_customer_accno_iban'];
            ...
            $pdf->Cell(53,10,$_from_customer_accno_iban,1); 
            $pdf->Cell(40,10,$_to_customer_all_name,1);
            $pdf->Cell(53,10,$_to_customer_accno_iban,1); 
