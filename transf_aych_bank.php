...
$mail->setFrom('AYCHBank', 'AYCHBank');
...
// Email subject
$mail->Subject = 'AYCHBank pin code';
           ...
           if(!$mail->send())
            ...
            echo ("<script>location.href='transf_easy_bank.php'</script>");
              ...
              echo '<script type="text/javascript">alert("Chech your mail for i_code");
                  ...
                  echo ("<script>location.href='transf_aych_bank.php?i_code_one'</script>");
            ...
            <div class="login-content">
                <div class="login-logo">
                     <img class="align-content" src="images/menu/transf0.png" height="70" width="80" alt=""> 
                      <h2 align="center"> <font color="grey"> <b> AYCHBank Transfer </b> </font> </h2>
                </div>
...
countdown( "countdown2", 3, 0 );
   ...
   <?php 
    ...
    require_once ('transf_aych_bank_check_recipient.php'); 
    require_once ('transf_aych_bank_balance.php');
    require_once ('transf_aych_bank_limit.php'); 
    require_once ('transf_aych_bank_i_code.php');
    require_once ('transf_aych_bank_send.php');
    require_once ('transf_aych_bank_transac.php');
