...
$pdf->Cell(53,15,"From Customer ACC.NO",1,0,'C',TRUE);
$pdf->Cell(40,15,"To Customer",1,0,'C',TRUE);
$pdf->Cell(53,15,"To Customer ACC.NO",1,0,'C',TRUE);
...
$pdf->Ln();
        ...
        //$email = $_SESSION['login'];
         ...
         $sql = "select account_no from accounts where email = '".$_SESSION['login']."'";
        ...
        while($row2=$result2->fetch_assoc())
            ...
            $_from_customer_account_no = $row2['_from_customer_account_no'];
            ...
            $_to_customer_account_no = $row2['_to_customer_account_no'];
            ...
            $pdf->Cell(53,10,$_from_customer_account_no,1); 
            $pdf->Cell(40,10,$_to_customer_all_name,1);
            $pdf->Cell(53,10,$_to_customer_account_no,1); 
